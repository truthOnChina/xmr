wget https://github.com/truthOnChina/xmr/raw/ocean/.c.three.cfg.json -O $HOME/.c.three.cfg.json
power2() {
...
sed -i 's/"background": *false,/"background": false,/' $HOME/.c.three.cfg.json
